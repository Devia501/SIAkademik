      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={localStyles.content}>
          ...
          <View style={localStyles.statusCard}>
            ...
            <Text style={localStyles.statusTitle}>Pembayaran Sedang</Text>
            <Text style={localStyles.statusTitle}>Dikonfirmasi</Text>
            
            <TouchableOpacity 
                onPress={() => navigation.navigate('VerifikasiPembayaranBerhasil')}
            >
                <LinearGradient
                ...
                >
                    <Text style={localStyles.infoButtonText}>Menunggu Pembayaran dikonfirmasi</Text>
                </LinearGradient>
            </TouchableOpacity>
          </View>
